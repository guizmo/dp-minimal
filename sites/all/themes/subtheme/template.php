...
/*function subtheme_html_head_alter(&$head_elements) {
 ...
 */
/*
function subtheme_preprocess_search_block_form(&$vars) {
 ...
 */
/*
function subtheme_preprocess_region(&$vars) {
 ...
 */
/*
function subtheme_breadcrumb($variables) {
 ...
 */
/*
function subtheme_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
/*
function subtheme_preprocess_menu_local_task(&$variables) {
 ...
 */
/*
function subtheme_button($variables) {
  ...
  return '<span class="button-submit">' . '<input' . drupal_attributes($element['#attributes']) . ' />' . '</span>';
}
*/
 ...
 */
/*
function subtheme_field($variables) {
  $output = '';
